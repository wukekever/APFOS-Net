...
def load_param(net, path):
    if os.path.exists(path):
        ...
        Xavier_initi(net)
        save_param(net, path="./pkl_uniform_case_2/Xavier_initi_net_params_case_2.pkl")


# In[ ]:


load_param(net, path="./pkl_uniform_case_2/Xavier_initi_net_params_case_2.pkl")
...
for it in range(Iter):
    ...
    if it % 1 == 0:
        ...
        print("")
    path = "./pkl_uniform_case_2/net_params_case_2_{}.pkl".format(it)
    if it % 1000 == 0:
        save_param(net, path)
...
save_param(net, path="./pkl_uniform_case_2/net_params_case_2.pkl")
np.save("loss_uniform_case_2.npy", loss_record)
np.save("error_uniform_case_2.npy", error_record)
time_end = time.time()
